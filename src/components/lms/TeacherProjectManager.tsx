...
const emptyProject: TeacherProjectInput = {
  title: '', slug: '', shortDescription: '', description: '', category: 'Robotics Projects', classLevel: 'Class 6', level: 'Beginner', estimatedTime: 'Self-paced', thumbnailUrl: '', videoUrl: '', circuitDiagramUrl: '', sourceCode: '', steps: [], troubleshooting: [], isPublished: false,
};

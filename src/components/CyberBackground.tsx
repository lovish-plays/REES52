    ...
    <div className="fixed inset-0 pointer-events-none select-none z-[-1] overflow-hidden bg-[#f7fbff]">
      ...
      {isLargeScreen && (
        ...
        >
          ...
          <g className={shouldAnimate ? "bg-joint-spin" : ""}>
          ...
          <g className={shouldAnimate ? "bg-joint-pulse" : ""}>
          ...
          <g className={shouldAnimate ? "bg-hud-flicker" : ""}>
      ...
      {isLargeScreen && (
        ...
        >
          ...
          <path 
            ...
            fill="currentColor" 
            className={`opacity-15 ${shouldAnimate ? "bg-visor-glow" : ""}`}
          />
          <path 
            d="M 125 250 L 70 250 L 50 290 L 105 340 L 138 290 Z" 
            strokeWidth="2.5" 
          ...
          <circle cx="75" cy="275" r="4" fill="currentColor" className={shouldAnimate ? "bg-hud-flicker" : ""} />
          <line x1="50" y1="290" x2="160" y2="290" strokeWidth="1" strokeDasharray="3,3" className={shouldAnimate ? "bg-hud-flicker" : ""} />

...
export default function AelosChatbot() {
  ...
  const getBotResponse = (input: string): Omit<Message, "sender" | "timestamp"> => {
    ...
    if (q.includes("help") || q.includes("support") || q.includes("email") || q.includes("contact")) {
      return {
        text: "I'm on it! You can contact the REES52 official support team at info@rees52.tech for catalog requests or hardware troubleshooting. Let me know if I can guide you to any portal section instead!"
      };
    }

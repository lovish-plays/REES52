    ...
    return (
      <div className="flex items-center justify-center min-h-[50vh]">
        <div className="text-center py-10 flex flex-col items-center justify-center">
          ...
          <p className="text-xs uppercase tracking-widest text-slate-600 font-bold">Redirecting...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="w-full max-w-md mx-auto p-6 md:p-8 glassmorphism border border-slate-200/50 shadow-2xl rounded-2xl bg-[#F7F4EB]/90 text-slate-800 animate-fade-in my-12">
      ...
      {showSuccess ? (
        ...
        <>
            ...
            <div className="flex items-center gap-2 mb-1.5">
              {mode !== "signin" && (
                <button
                  ...
                  className="p-1 rounded-lg hover:bg-slate-200/50 text-slate-600 hover:text-slate-800 transition-colors cursor-pointer animate-fade-in"
                  type="button"
                  aria-label="Back"
                >
          ...
          {infoMessage && (
            <div className="mb-4 rounded-xl border border-cyan-500/20 bg-cyan-50 px-4 py-3 text-xs text-cyan-950 flex flex-col gap-1.5 animate-fade-scale">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {(mode === "signin" || mode === "signup") && (
              <>
                <div className="relative my-6 flex items-center justify-center">
                  ...
                  <span className="relative bg-[#F7F4EB] px-4 text-[10px] font-black uppercase tracking-widest text-slate-500">
                    OR
                  </span>
                </div>
            ...
            {mode !== "otp" && mode !== "reset" && (
              <button
                ...
                className="w-full text-center text-[10px] font-black uppercase tracking-widest text-cyan-800 hover:text-cyan-700 transition-colors mt-4 cursor-pointer border-none bg-transparent"
              >
                {mode === "signup"
